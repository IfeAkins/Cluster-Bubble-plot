library(tidyverse)
#setwd
setwd("~/Documents/project/") #review to set to your working dir
# 1. Load data
...
p <- ggplot(figure1_count,
  ...
  # Labels
  labs(title = "Cluster timeline using Illumina data",
       x = "Week", y = "Cluster ID", fill  = "Species", size  = "No. of patients") + 
  # Theme
  theme_minimal() +
